...
int main()
{
    ...
    do {
        ...
        cout << "Welcome to Grammar Practice!" << endl;
        ...
        switch (choice) {
		 ...
		 case 'A': 
             case 'a': {
                ...
                for (const auto& test : testsA) {
                    cout << "\nQuestion: " << test.aQuestion << endl;
                    cout << "Your Answer: ";
                    string userAnswer;
                    getline(cin, userAnswer);
                    if (userAnswer == test.aAnswer) {
                        cout << "\nCorrect!" << endl;
                    } else {
             ...
             case 'b': {
                ...
                cout << "Please correct the following sentences:\n" << endl;
                for (const auto& test : testsB) {
                    cout << "\nQuestion: " << test.bQuestion << endl;
                    cout << "Your Answer: ";
                    string userAnswer;
                    getline(cin, userAnswer);
                    if (userAnswer == test.bAnswer) {
                        cout << "\nCorrect!" << endl;
                    } else {
				...
				break;
                     ...
                     case 'c': {
                         ...
                         cout << "Please correct the following sentences:\n" << endl;
                         for (const auto& test : testsC) {
                             cout << "\nQuestion: " << test.cQuestion << endl;
                             cout << "Your Answer: ";
                             string userAnswer;
                             getline(cin, userAnswer);
                             if (userAnswer == test.cAnswer) {
                                 cout << "\nCorrect!" << endl;
                             }
                             else {
